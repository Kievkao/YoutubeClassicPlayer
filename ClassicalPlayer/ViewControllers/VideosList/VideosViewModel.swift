...
class VideosViewModel {
    ...
    init(videosService: VideoSearchServiceProtocol, composerName: String, portionSize: UInt) {
...
//        }
    ...
    private func loadVideosFromNetwork() {
        videosService.searchVideos(composerName, portionSize: portionSize, pageToken: pageToken) { [weak self] videos, pageToken, error in
